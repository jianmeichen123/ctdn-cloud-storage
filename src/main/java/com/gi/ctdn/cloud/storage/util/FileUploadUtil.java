...
import com.gi.ctdn.cloud.storage.param.FileUploadParam;
import com.gi.ctdn.cloud.storage.vo.FileUploadErrorVO;
...
//	}
	...
	public static void updateSize(File filePath,File toFilePath,int new_w, int new_h,boolean is_watermark,boolean keepAspectRatio) throws Exception {
		try{
			Thumbnails.Builder<File> b = Thumbnails.of(filePath);
			b.size(new_w, new_h);
